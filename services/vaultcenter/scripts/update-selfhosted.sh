...
REPO_ROOT="${VEILKEY_UPDATE_REPO_ROOT:?VEILKEY_UPDATE_REPO_ROOT is required}"
REMOTE_NAME="${VEILKEY_UPDATE_REMOTE:?VEILKEY_UPDATE_REMOTE is required}"
BRANCH_NAME="${VEILKEY_UPDATE_BRANCH:?VEILKEY_UPDATE_BRANCH is required}"
SERVICE_NAME="${VEILKEY_UPDATE_SERVICE_NAME:?VEILKEY_UPDATE_SERVICE_NAME is required}"
HEALTH_URL="${VEILKEY_UPDATE_HEALTH_URL:?VEILKEY_UPDATE_HEALTH_URL is required}"
INSTALL_BIN="${VEILKEY_UPDATE_INSTALL_BIN:?VEILKEY_UPDATE_INSTALL_BIN is required}"
BUILD_WORKDIR="${REPO_ROOT}/services/vaultcenter"
TARGET_VERSION="${VEILKEY_UPDATE_TARGET_VERSION:-}"
CURRENT_VERSION="${VEILKEY_UPDATE_CURRENT_VERSION:-}"
RELEASE_CHANNEL="${VEILKEY_UPDATE_RELEASE_CHANNEL:?VEILKEY_UPDATE_RELEASE_CHANNEL is required}"

log() {
  printf '[vaultcenter-update] %s\n' "$*"
}
